...
const FAQ_MAP: { keyword: string; answer: string }[] = [
  ...
  { keyword: 'who is reseller', answer: 'Resellers are independent distributors who buy TaskBloom voucher codes in bulk at wholesale prices and sell them to workers. Contact support for reseller recommendations. To become one: register at /reseller.' },
