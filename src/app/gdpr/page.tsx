  ...
  return (
    <LegalLayout title="GDPR Compliance" updated="7 May 2026">
      ...
      <ul>
        ...
        <li>Direct communications about your account</li>
      </ul>
      ...
      <p>As a data subject, you have the following rights under UK GDPR and EU GDPR:</p>
      ...
      <ul>
        <li>Email: dpo@taskbloom.co.uk</li>
        <li>Subject line: &ldquo;GDPR Request — [Your Name]&rdquo;</li>
      </ul>
      <p>
      ...
      <p>
        <strong>UK users:</strong> Information Commissioner&apos;s Office (ICO)<br />
        Website: ico.org.uk
      </p>
      <p>
        <strong>EU users:</strong> Your local data protection authority
      </p>
      <p>
