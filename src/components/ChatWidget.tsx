...
const KNOWLEDGE_BASE: { keyword: string; answer: string }[] = [
  ...
  { keyword: 'how to register', answer: 'To register on TaskBloom:\n 1) Go to the Register page\n 2) Enter your full name and email\n 3) Create a password (min 8 characters)\n 4) You need a voucher code to register\n 5) Enter referral code if you have one (optional)\n 6) Click "Create Account"\n\nNote: A valid voucher code is required.\nPurchase one from a reseller if you don\'t have it.' },
  { keyword: 'create account', answer: 'To create an account on TaskBloom:\n 1) Go to taskbloom.co.uk/register\n 2) Fill in: Full Name, Email, Password (min 8 chars)\n 3) Enter a valid voucher code (required)\n 4) Add referral code if invited (optional)\n 5) Click "Create Account"\n\nAfter registering: You\'ll be redirected to your dashboard to start completing tasks.' },
  { keyword: 'voucher code', answer: 'A voucher code is required to register on TaskBloom.\n\nHow to get one:\n- Purchase from a reseller\n- Use a provided code\n\nVoucher codes activate your package (e.g. Bronze, Silver, Gold) and unlock your account.' },
  { keyword: 'voucher required', answer: 'Yes, a valid voucher code is required to create an account on TaskBloom. You cannot register without one.\n\nDon\'t have one? Purchase from a reseller.' },
  { keyword: 'how to start', answer: 'Getting started on TaskBloom:\n 1) Get a voucher code from a reseller\n 2) Go to the Register page\n 3) Enter your name, email, and password (min 8 chars)\n 4) Enter your voucher code (required)\n 5) Add referral code if you have one (optional)\n 6) Click "Create Account"\n\nAfter registration: Start browsing tasks in your dashboard and earn money!' },
