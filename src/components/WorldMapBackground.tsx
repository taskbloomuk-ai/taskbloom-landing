...
// Deterministic "random" values based on index (same on server & client)
function seededValue(i: number, seed: number) { return ((i * 7 + seed * 13) % 100) / 100; }
      ...
      {allCities.map((city, i) => (
        <div
          ...
          style={{
            ...
            animationDelay: `${seededValue(i, 3) * 4}s`,
            animationDuration: `${2 + seededValue(i, 7) * 2}s`,
